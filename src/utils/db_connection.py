...
connection_string = os.getenv("COSMOS_DB_CONNECTION_STRING", "mongodb://mongodb:27017")
database_name = os.getenv("COSMOS_DB_DATABASE_NAME", "test-db")  # Default to 'dashboard' if not specified
